...
def load_config():
    ...
    default_config = {
        ...
        "Рубли (безнал) → Донги (нал)": 250  # Добавляем курс для новой пары
    },
    "default_pairs": [
        ...
        "USDT → Рубли (безнал)",
        "Рубли (безнал) → USDT",
        "Рубли (безнал) → Донги (нал)"  # Добавляем новую пару
    ],
    ...
    "currencies": {
        ...
        "Рубли (безнал) → Донги (нал)": "донгов"  # Добавляем валюту для новой пары
    }
}
    try:
